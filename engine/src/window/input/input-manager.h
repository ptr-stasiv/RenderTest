...
namespace input
{
   ...
   private:
      ...
      std::shared_ptr<native::NativeInputManager> NativeInputManager;
   public:

      inline InputManager(const std::shared_ptr<app::Window>& window)
      {
         NativeInputManager = std::make_shared<native::NativeInputManager>(window);
      }
